...
import 'package:gurudwara/features/auth/screens/otp_bottom_sheet.dart';
...
class AuthController extends GetxController {
  ...
  void handleSendOTP(BuildContext context) async {
    if (!formKey.currentState!.validate()) return;
  ...
  void showOTPBottomSheet(BuildContext context) {
    showModalBottomSheet(
      ...
      builder: (context) => OtpBottomSheet(authController: this),
    );
  }
}